            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li class="menu_inserita"><a class="dropdown-item" href="{{route('nuovaGara')}}">Nuove Gare</a></li>
                        ...
                        <li class="menu_partecipare"><a class="dropdown-item" href="{{route('daPartecipare')}}">Da partecipare</a></li>
                        <li class="menu_partecipata"><a class="dropdown-item" href="{{route('partecipata')}}">Partecipata</a></li>
                        <li><a class="dropdown-item" href="{{route('revocata')}}">Revocata</a></li>
                        <li class="menu_scartata"><a class="dropdown-item" href="{{route('scartata')}}">Scartata</a></li>
                        <li class="menu_eliminata"><a class="dropdown-item" href="{{route('eliminata')}}">Eliminata</a></li>
